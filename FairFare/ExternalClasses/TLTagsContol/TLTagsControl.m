...
//    if ([tagInputField_ respondsToSelector:@selector(setAttributedPlaceholder:)]) {
//        UIColor *color = [UIColor blackColor];
//        tagInputField_.attributedPlaceholder = [[NSAttributedString alloc] initWithString:self.tagPlaceholder attributes:@{NSForegroundColorAttributeName: color}];
//    } else {
...
//    }
    ...
    UIView *paddingView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 5, 22)];
    tagInputField_.leftView = paddingView;
    tagInputField_.leftViewMode = UITextFieldViewModeAlways;
    ...
    tagInputField_.font = [UIFont fontWithName:@"Helvetica-Light" size:14];
    tagInputField_.placeholder = NSLocalizedString(@"tag", nil);
...
- (void)layoutSubviews {
    ...
    [tagInputField_ setValue:RGBCOLOR(37, 35, 35, 1) forKeyPath:@"_placeholderLabel.textColor"];

    tagInputField_.placeholder = (_tagPlaceholder == nil) ? NSLocalizedString(@"tag",nil) : _tagPlaceholder;
}
...
- (void)reloadTagSubviews {
    ...
    UIColor *tagBackgrounColor = _tagsBackgroundColor != nil ? _tagsBackgroundColor : [UIColor colorWithRed:0.9
                                                                                                      green:0.91
                                                                                                       blue:0.925
                                                                                                      alpha:1];
    UIColor *tagTextColor = _tagsTextColor != nil ? _tagsTextColor : RGBCOLOR(37, 35, 35, 1);
