...
#define CZP_BACKGROUND_ALPHA 0.5
#else
#define CZP_BACKGROUND_ALPHA 0.5
#endif
...
- (id)initWithHeaderTitle:(NSString *)headerTitle
    ...
    if(self){
      ...
      // [ self. setBackgroundColor:[UIColor blackColor]];
        ...
        self.headerTitleColor = [UIColor darkGrayColor];
        self.headerBackgroundColor = [UIColor groupTableViewBackgroundColor];
        ...
        self.confirmButtonBackgroundColor = [UIColor colorWithRed:218.0/255 green:82.0/255 blue:80.0/255 alpha:1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [[UITableViewCell appearance] setTintColor:[UIColor colorWithRed:218.0/255 green:82.0/255 blue:80.0/255 alpha:1]];
