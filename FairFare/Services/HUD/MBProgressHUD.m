...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
		self.labelFont = [UIFont fontWithName:@"HelveticaNeue-Light" size:20.0];
        ...
        if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0) {
            //blurred effect
            UIToolbar *_blurBackgroundView = [[UIToolbar alloc] initWithFrame:self.bounds];
            [_blurBackgroundView setAutoresizingMask:self.autoresizingMask];
