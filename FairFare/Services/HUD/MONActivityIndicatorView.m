...
- (void)setupDefaults {
    ...
    self.delay = 0.1;
    self.duration = 0.3;
   // self.defaultColor = [UIColor colorWithRed:174.0/255.0 green:0.0 blue:0.0 alpha:1.0];
    
    self.defaultColor = [UIColor colorWithRed:79.0/255.0 green:70.0/255.0 blue:117.0/255.0 alpha:1.0];
