...
- (CGRect)textRectForBounds:(CGRect)bounds {
    return CGRectMake(4, 4, bounds.size.width-18, bounds.size.height);
}
...
-(void)initialization{
    ...
    if (_selectedPlaceHolderColor==nil) {
        _selectedPlaceHolderColor = [UIColor lightGrayColor];
    }
    ...
    if (_selectedLineColor==nil) {
        _selectedLineColor = [UIColor lightGrayColor];
    }
